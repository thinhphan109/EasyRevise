...
// Supports: text, int, float, dropdown, alternatives, caseSensitive
// ========================
            ...
            if (q.isFreeForm) {
                ...
                responseRow = `
                    <div style="margin-bottom: 1rem;">
                        ...
                        <div style="margin-top: 0.5rem; padding: 1rem; background:rgba(255,255,255,0.03); border-radius: 12px; color: var(--text-muted); font-size: 0.9rem; white-space: pre-line;">${escapeHtml(resultEntry?.userAnswer) || 'Không có bài làm.'}</div>
