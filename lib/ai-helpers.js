...
refreshSettings();
setInterval(refreshSettings, 30_000).unref();
 ...
 *  @param {string} purposeModel  optional override (e.g. 'gradeModel', 'ocrModel') */
function getAIConfig(purposeModel) {
    ...
    const model = purposeModel || _settingsCache.generateModel || process.env.CLAUDE_MODEL || 'claude-sonnet-4-20250514';
