...
// Runtime pool prefers transaction-mode pooler (port 6543) for higher
// connection efficiency. Session-mode (5432) is reserved for DDL/migrations.
const dbUrl = env.SUPABASE_DB_URL_TX || env.SUPABASE_DB_URL;
