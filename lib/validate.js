...
function validateQuestion(body, sectionType) {
    ...
    if (sectionType === 'fill-in-blank' && body.blanks) {
        ...
        for (let i = 0; i < body.blanks.length; i++) {
            ...
            // Type check: when an answer is provided it must be a string or number.
            ...
            // Reject explicit empty string. Allow `undefined`/`null` so admin can
            // save in-progress drafts and fill the answer later.
